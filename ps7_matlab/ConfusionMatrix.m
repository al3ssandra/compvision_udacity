...
CMatrix_11 = numel(I(I == 1))/size(CM_dataA1,1); 
CMatrix_12 = numel(I(I == 2))/size(CM_dataA1,1);
CMatrix_13 = numel(I(I == 3))/size(CM_dataA1,1);
...
CMatrix_21 = numel(I(I == 1))/size(CM_dataA1,1); 
CMatrix_22 = numel(I(I == 2))/size(CM_dataA1,1);
CMatrix_23 = numel(I(I == 3))/size(CM_dataA1,1);
...
CMatrix_31 = numel(I(I == 1))/size(CM_dataA1,1); 
CMatrix_32 = numel(I(I == 2))/size(CM_dataA1,1);
CMatrix_33 = numel(I(I == 3))/size(CM_dataA1,1);
